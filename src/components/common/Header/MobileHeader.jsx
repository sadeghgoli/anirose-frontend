...
const MobileHeader = ({ data, isLoggedIn }) => {
                    ...
                    >
                        <Link href={data?.logo?.link || "/"}>
                            <Image src={data?.logo?.src || "/images/test/Group-43-1.png"} alt={data?.logo?.alt || "لوگوی آنی رز"}
                                 width={43} height={0} sizes="100vw" className="border-none"  loading="lazy" />
                        </Link>
                    </div>
                        ...
                        {bottomNav.slice(0, 4).map((item) => {
                            ...
                            return (
                                <li key={item.id} className="flex-shrink-0">
                                    ...
                                    >
                                        <span className="flex text-[18px]" style={{ color: active ? "#64a39a" : "currentColor" }}>
                                            {icons[item.icon] || <HomeIcon />}
                                        </span>
                                        <span className="flex text-[12px] leading-[17px] tracking-[.48px] whitespace-nowrap">
                                            {item.title}
                                        </span>
                                    </Link>
                                </li>
