...
export const metadata = {
  title: "سوالات متداول | آنی روز",
  description: "پاسخ به سوالات متداول درباره خرید، ارسال، پرداخت و بازگشت کالا از فروشگاه آنی روز",
  alternates: {
    canonical: "https://aniroz.ir/faq",
  },
  openGraph: {
    title: "سوالات متداول | آنی روز",
    description: "پاسخ به سوالات متداول درباره خرید از آنی روز",
...
const faqs = [
  ...
  {
    question: "آیا محصولات آنی روز ارگانیک هستند؟",
  ...
  },
  {
    ...
    answer: "شما می‌توانید از طریق صفحه تماس با ما، تلفن پشتیبانی و ایمیل در ساعات کاری با تیم پشتیبانی آنی روز در ارتباط باشید.",
  },
];
